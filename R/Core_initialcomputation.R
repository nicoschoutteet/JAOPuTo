#' Core - Initial Computation (Virgin Domain)
#'
...
#' @export
#'
#' @examples JAOPuTo_Core_initialcomputation(as.POSIXct("2024-01-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-01-01 23:00", "Europe/Brussels"))
JAOPuTo_Core_initialcomputation <- function(StartDateTime,
                                              EndDateTime,
                                              Presolved = TRUE) {

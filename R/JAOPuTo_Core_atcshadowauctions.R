...
#'
#' @description
#' Download ATCs for shadow auctions in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_atcshadowauctions(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_atcshadowauctions <- function(start,
                                            end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/shadowAuctionATC",
    start = start,
    end = end

#' Core - Final Bilateral Exchange Restrictions
#'
#' @description
#' Download final bilateral exchange restrictions between selected bidding zones in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_bexrestrictions(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_bexrestrictions <- function(start,
                                      end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/bexRestrictions",
    start = start,
    end = end

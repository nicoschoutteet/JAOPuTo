#' CoreID - IDCC(a) - Initial NTCs for SIDC
#'
...
#'
#' @return a dataframe containing the initial leftover net transmission capacity after the day-ahead market before TSO validation for defined borders in both directions in MW.
#' @import httr
#' @import jsonlite
#' @import dplyr
#' @import tidyr
...
#' @export
#'
#' @examples JAOPuTo_CoreID_IDCCa_initialNTC(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_IDCCa_initialNTC <- function(StartDateTime,
                                            EndDateTime) {

  df <- tibble::tibble()

  API_GET <- httr::GET("https://publicationtool.jao.eu/coreid/api/data/IDCCA_initialNtc",
                       query = list(

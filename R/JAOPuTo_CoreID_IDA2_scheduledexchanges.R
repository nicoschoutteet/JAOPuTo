#' Core IDA2 - Sheduled Exchanges
#'
#' @description
#' Download  bilateral scheduled exchanges between selected bidding zones in Core intraday auction 2.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_CoreID_IDA2_scheduledexchanges(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_CoreID_IDA2_scheduledexchanges <- function(start,
                                                   end) {
  # access helper function
  JAOPuTo_get(

    dataset = "coreID",
    endpoint = "api/data/ID2_scheduledExchanges",
    start = start,
    end = end

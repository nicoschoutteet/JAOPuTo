#' CoreID - IDCCb - Validation Reductions
#'
...
#' @export
#'
#' @examples JAOPuTo_CoreID_IDCCb_validationreductions(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_IDCCb_validationreductions <- function(StartDateTime,
                                              EndDateTime) {

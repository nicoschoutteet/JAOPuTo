#' Core IDA1 - Net Position
#'
#' @description
#' Download Core net position for selected bidding zones in Core intraday auction 1.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_IDA1_netposition(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_IDA1_netposition <- function(start,
                                          end) {
  # access helper function
  JAOPuTo_get(

    dataset = "coreID",
    endpoint = "api/data/ID1_netPos",
    start = start,
    end = end

...
#' @export
#'
#' @examples JAOPuTo_CoreID_ID2_pricespreads(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_ID2_pricespreads <- function(StartDateTime,
                                            EndDateTime) {

  df <- tibble::tibble()

  API_GET <- httr::GET("https://publicationtool.jao.eu/coreid/api/data/ID2_priceSpread",
                       query = list(

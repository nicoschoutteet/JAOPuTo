#' CoreID - IDCCb - Reference Programs
#'
...
#' @export
#'
#' @examples JAOPuTo_CoreID_IDCCb_refprog(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_IDCCb_refprog <- function(StartDateTime,
                                 EndDateTime) {

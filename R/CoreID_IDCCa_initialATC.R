#' CoreID - IDCC(a) - Initial ATCs for SIDC
#'
...
#'
#' @return a dataframe containing the initial leftover available transmission capacity after the day-ahead market before TSO validation for defined borders in both directions in MW.
#' @import tibble
#' @import httr
#' @import jsonlite
#' @import dplyr
...
#' @export
#'
#' @examples JAOPuTo_CoreID_IDCCa_initialATC(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_IDCCa_initialATC <- function(StartDateTime,
                                     EndDateTime) {

  df <- tibble::tibble()

  API_GET <- httr::GET("https://publicationtool.jao.eu/coreid/api/data/IDCCA_initialAtc",
                       query = list(

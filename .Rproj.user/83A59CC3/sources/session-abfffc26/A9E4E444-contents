#' Core - Reference Program
#'
#' @description
#' Download reference programs of Core and non-Core bidding zone borders in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_refprog(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_refprog <- function(start,
                                   end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/refprog",
    start = start,
    end = end

#' CoreID - IDCC(b) - Final ATCs for SIDC
#'
...
#' @export
#'
#' @examples JAOPuTo_CoreID_IDCCb_finalATC(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_IDCCb_finalATC <- function(StartDateTime,
                                          EndDateTime) {

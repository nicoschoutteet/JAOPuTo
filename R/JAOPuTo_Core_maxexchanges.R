#' Core - Max Exchanges (MaxBex)
#'
#' @description
#' Download maximum bilateral exchanges between selected bidding zones in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_maxexchanges(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_maxexchanges <- function(start,
                                   end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/maxExchanges",
    start = start,
    end = end

#' Core IDA2 - Net Position
#'
#' @description
#' Download Core net position for selected bidding zones in Core intraday auction 2.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_IDA2_netposition(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_IDA2_netposition <- function(start,
                                          end) {
  # access helper function
  JAOPuTo_get(

    dataset = "coreID",
    endpoint = "api/data/ID2_netPos",
    start = start,
    end = end

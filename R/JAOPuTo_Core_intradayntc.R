...
#'
#' @description
#' Download Intraday NTCs on bidding zone borders in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_intradayntc(
#'   start = "2024-01-01 00:00",
#'   end = "2024-01-10 23:00"
#' )
#' }
JAOPuTo_Core_intradayntc <- function(start,
                                     end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/intradayNTC",
    start = start,
    end = end

#' Corev IDA3 - Congestion Income
#'
#' @description
#' Download congestion income generated in Core intraday auction 3.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_CoreID_IDA3_congestionincome(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_CoreID_IDA3_congestionincome <- function(start,
                                                 end) {
  # access helper function
  JAOPuTo_get(

    dataset = "coreID",
    endpoint = "api/data/ID3_congestionIncome",
    start = start,
    end = end

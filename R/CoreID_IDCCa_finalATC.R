#' CoreID - IDCC(a) - Final ATCs for SIDC
#'
...
#'
#' @return a dataframe containing the final leftover available transmission capacity after the day-ahead market after TSO validation for defined borders in both directions in MW.
#' @import tibble
#' @import httr
#' @import jsonlite
#' @import dplyr
...
#' @export
#'
#' @examples JAOPuTo_CoreID_IDCCa_finalATC(as.POSIXct("2024-07-01 00:00", "Europe/Brussels"),
#' as.POSIXct("2024-07-01 23:00", "Europe/Brussels"))
JAOPuTo_CoreID_IDCCa_finalATC <- function(StartDateTime,
                                            EndDateTime) {

  df <- tibble::tibble()

  API_GET <- httr::GET("https://publicationtool.jao.eu/coreid/api/data/IDCCA_intradayAtc",
                       query = list(

...
#'
#' @description
#' Download curative remedial actions applied in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_racurative(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }11
JAOPuTo_Core_racurative <- function(start,
                                      end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/cra",
    start = start,
    end = end
    ...
    dplyr::mutate(dateTimeUtc = lubridate::ymd_hms(.data$dateTimeUtc, tz = "UTC"),
                  ...
                  TSO = dplyr::case_match(.data$cnecTso,

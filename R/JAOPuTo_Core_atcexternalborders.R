#' Core - ATCs on Core external borders
#'
#' @description
#' Download ATCs on external borders in Core DA FBMC.
#'
...
#' @examples
#' \dontrun{
#' JAOPuTo_Core_atcexternalborders(
#'   start = "2025-01-01 00:00",
#'   end = "2025-01-10 23:00"
#' )
#' }
JAOPuTo_Core_atcexternalborders <- function(start,
                                            end) {
  # access helper function
  JAOPuTo_get(

    dataset = "core",
    endpoint = "api/data/atc",
    start = start,
    end = end

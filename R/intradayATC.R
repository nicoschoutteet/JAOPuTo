...
#'
#' @return a dataframe containing the intraday ATC values on borders between Core bidding zones
#' @export
#' @import magrittr
#' @import tidyr
#' @import dplyr
...
#' @import tidyselect
#'
#' @examples df <- JAOPuTo_intradayATC(as.POSIXct("2022-06-09 00:00", "CET"), as.POSIXct("2022-12-31 23:00", "CET"))
JAOPuTo_intradayATC <- function(StartDateTime,
                                EndDateTime) {

  df <- tibble::tibble()

  list <- httr::GET("https://publicationtool.jao.eu/core/api/data/intradayAtc",
